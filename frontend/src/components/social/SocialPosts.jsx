...
export default function SocialPosts () {
  return (
    <div className='d-flex flex-column gap-4'>
      {posts.map(post => (
        <div key={post.id} className='post_deisgn  shadow-sm bg-white'>
            ...
            <div className='d-flex align-items-center justify-content-between flex-wrap gap-3 pt-2 border-top'>
              <div className='d-flex gap-3'>
                <button className='btn btn-link p-0 text-muted d-flex align-items-center gap-2'>
                  <ThumbsUp size={20} strokeWidth={1.5} /> <p>{post.likes}</p>
                </button>
                <button className='btn btn-link p-0 text-muted d-flex align-items-center gap-2'>
                  <MessageCircle size={20} strokeWidth={1.5} /> <p>{post.comments}</p>
                </button>
                <button className='btn btn-link p-0 text-muted d-flex align-items-center gap-2'>
