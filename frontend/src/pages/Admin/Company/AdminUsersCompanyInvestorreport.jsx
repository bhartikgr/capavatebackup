...
import AdminCompanyInvestorReporting from "../../../components/Admin/company/AdminCompanyInvestorReporting";
function AdminUsersCompanyInvestorreport() {
  ...
  document.title = "Company Investor Reporting - Admin";
  useEffect(() => {
    getcompnayInvestorReport();
  }, []);
  const getcompnayInvestorReport = async () => {
    let formData = {
      company_id: id,
    };
    ...
    try {
      const res = await axios.post(
        apiUrl + "getcompnayInvestorReporting",
        formData,
        {
          headers: {
          ...
          {openDropdown === row.id && (
            ...
            >
              <Link
                ...
                onClick={() => handleclickInvestorReport(row.id)}
  ...
  const handleclickInvestorReport = (rep_id) => {
    setReportId(rep_id);
...
`}</style>;
export default AdminUsersCompanyInvestorreport;
