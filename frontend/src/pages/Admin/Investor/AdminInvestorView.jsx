...
import { Share2, FileText, File, Users } from "lucide-react";
import { Modal, Button } from "antd";
import { FaDownload, FaEye } from "react-icons/fa"; // FontAwesome icons
import axios from "axios";
import { useNavigate, Link, useParams } from "react-router-dom";
import AdminiInvestorReportTable from "../../../components/Admin/investor/AdminiInvestorReportTable";
import AdminiInvestorDataroomTable from "../../../components/Admin/investor/AdminiInvestorDataroomTable";
function AdminInvestorView() {
  ...
  const getcompanyInvestor = async () => {
    ...
    try {
      const res = await axios.post(
        apiUrlCompany + "getInvestorDetails",
        formData,
        {
          headers: {
            Accept: "application/json",
                ...
                <div className="row gy-4">
                    ...
                    <div className="row gy-4">
                      ...
                      <div className="col-md-4">
                        <div className="d-flex align-items-center gap-2 dashmain_box">
                          ...
                          <div className="d-flex flex-column gap-0">
                            <h4>Total Dataroom Management</h4>
                  ...
                  <div className="col-12">
                    <div className="card p-3">
                      <h5 className="mb-3">Investor Companies</h5>
                  ...
                  <AdminiInvestorReportTable id={id} />
                  <AdminiInvestorDataroomTable id={id} />
                </div>
              </div>
            </section>
          </div>
...
export default AdminInvestorView;
