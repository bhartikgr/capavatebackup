...
function AdminUsersCompany() {
      ...
      cell: (row) => (
        <div className="position-relative">
          ...
          {openDropdown === row.company_id && (
            ...
            >
              <Link
                to={`/admin/users/company/cap-table/${row.company_id}`}
              ...
              <Link
                to={`/admin/users/company/info/${row.company_id}`}
                className="dropdown-item"
                title="Company Info"
                style={{
                  display: "flex",
              ...
              {/* <Link
                to={`/admin/users/company/investor-info/${row.company_id}`}
                className="dropdown-item"
                title="Investor Info"
                style={{
                  display: "flex",
              ...
              <Link
                to={`/admin/company/investor-reporting/${row.company_id}`}
                className="dropdown-item"
              ...
              >
                <FaFileAlt style={{ fontSize: "16px", color: "#10b981" }} />
                <span>Investor Reporting</span>
              </Link>

              <Link
                to={`/admin/company/record-round/${row.company_id}`}
                className="dropdown-item"
              ...
              >
                <FaTable style={{ fontSize: "16px", color: "#10b981" }} />
  ...
  const handleexportdata = () => {
    ...
    const exportData = records.map((row) => ({
      ...
      "Total Signatory": row.total_signatory,
    }));
    ...
    saveAs(data, "company_export.xlsx");
  };
...
`}</style>;
export default AdminUsersCompany;
