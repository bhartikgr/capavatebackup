...
══════════════════════════════════════════════ */}
                <div className="container-fluid px-0">
                  ...
                  <div className="row g-2 mb-4">
                    {[
                      { label: 'Total Invested', value: `${InvestorInfo?.currency || '$'}${(InvestorInfo?.total_invested || 0).toLocaleString()}`, icon: '💰', color: '#16a34a', bg: '#f0fdf4', border: '#bbf7d0' },
                      { label: 'Ownership %', value: `${InvestorInfo?.ownership_percent || 0}%`, icon: '📊', color: '#2563eb', bg: '#eff6ff', border: '#bfdbfe' },
                      { label: 'Investor Rank', value: `#${InvestorInfo?.rank || 'N/A'}`, icon: '🏆', color: '#CC0000', bg: '#fff5f5', border: '#fecaca' },
                      { label: 'Min Invest', value: `${InvestorInfo?.currency || '$'}${(InvestorInfo?.min_investment || 0).toLocaleString()}`, icon: '📉', color: '#64748b', bg: '#f8fafc', border: '#e2e8f0' },
                      { label: 'Max Invest', value: `${InvestorInfo?.currency || '$'}${(InvestorInfo?.max_investment || 0).toLocaleString()}`, icon: '📈', color: '#64748b', bg: '#f8fafc', border: '#e2e8f0' },
                    ].map((m, i) => (
                      ...
                      <div className="col-md-6">
                        <SectionCard icon="📊" title="Investment Summary">
                          {[
                            ...
                            { label: 'Min Investment', val: `${InvestorInfo?.currency || '$'}${(InvestorInfo?.min_investment || 0).toLocaleString()}` },
                            { label: 'Max Investment', val: `${InvestorInfo?.currency || '$'}${(InvestorInfo?.max_investment || 0).toLocaleString()}` },
                        ...
                        <SectionCard icon="🎯" title="Capavate Network Interests">
                          ...
                          <div className="p-3 rounded-3" style={{ background: '#f8fafc', border: '1px solid #e2e8f0' }}>
                            ...
                            <div className="d-flex justify-content-between py-2" style={{ borderBottom: '1px solid #e2e8f0', fontSize: 13 }}>
                              ...
                              <strong style={{ color: '#16a34a' }}>{InvestorInfo?.currency || '$'}{(InvestorInfo?.min_investment || 0).toLocaleString()}</strong>
                            </div>
                            <div className="d-flex justify-content-between py-2" style={{ fontSize: 13 }}>
                              <span style={{ color: '#64748b' }}>Maximum</span>
                              <strong style={{ color: '#CC0000' }}>{InvestorInfo?.currency || '$'}{(InvestorInfo?.max_investment || 0).toLocaleString()}</strong>
                            </div>
                          </div>
                        </SectionCard>
                      </div>
