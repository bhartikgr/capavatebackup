                        ...
                        <div style={{ padding: '32px' }}>
                            ...
                            <div style={{
                                ...
                                <p style={{
                                    ...
                                    <strong>Trigger:</strong> When a Signatory selects one or more investors from the CRM and initiates sending an invitation to a round. Shown once per send action (may cover multiple recipients). Displayed before the invitation is dispatched.
                                </p>
                            </div>
