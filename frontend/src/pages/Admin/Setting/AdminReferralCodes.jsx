...
function AdminReferralCodes() {
  useEffect(() => {
    document.title = "Referral Codes- Admin";
  }, []);
  ...
  const getallreferredCode = async () => {
    let formData = {
      code: code,
    };
    try {
      const res = await axios.post(apiUrl + "getallreferredCode", formData, {
        headers: {
