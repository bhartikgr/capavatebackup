                        ...
                        <div style={{ padding: '32px', maxHeight: '70vh', overflowY: 'auto' }}>
                            ...
                            <div style={{
                                ...
                                <div style={{ padding: '24px' }}>
                                    ...
                                    <p style={{ fontSize: '14px', color: 'rgba(4,30,66,0.75)', lineHeight: '1.85', marginBottom: '10px' }}>
                                        By registering, you acknowledge and consent to the collection, processing, storage, and use of your personal data as described in the <a href="http://localhost:5000/privacy-policy" target='_blank' style={{ color: '#CC0000' }}>Privacy Policy</a>. Key acknowledgements:
                                    </p>
                                    <ul style={{ marginLeft: '20px', marginBottom: '10px' }}>
                                    ...
                                    <div style={{
                                        ...
                                        <p style={{
                                            ...
                                            <strong>By checking the box and clicking the button below, you confirm:</strong> (i) you have read and understood this Agreement and all Master Legal Documents at <a href="http://localhost:5000/privacy-policy" target='_blank' style={{ color: '#CC0000' }}>capavate.com/legal</a>; (ii) you meet all eligibility criteria; (iii) you agree to be legally bound by this Agreement, the <a href="#" style={{ color: '#CC0000' }}>Terms of Service</a>, <a href="#" style={{ color: '#CC0000' }}>Privacy Policy</a>, <a href="#" style={{ color: '#CC0000' }}>Acceptable Use Policy</a>, <a href="#" style={{ color: '#CC0000' }}>Cookie Policy</a>, and <a href="#" style={{ color: '#CC0000' }}>Disclaimer</a>; (iv) where acting on behalf of a company or entity, you have authority to bind that entity; and (v) you understand that Blueprint Catalyst Limited, Capavate, and its affiliates are not regulated financial advisers and that the Platform does not provide financial, investment, legal, or professional advice of any kind.
                                        </p>
                                    </div>
