          ...
          <div class="cards-stack">
            <div class="modern-card">
              <div class="card-top">
                <div class="user-meta">
                  <div class="avatar-wrapper">
                    <img
                      src="https://i.pravatar.cc/150?u=avinay"
                      alt="Avinay"
                      class="avatar-img"
                    />
                  ...
                  <div class="text-group">
                    <div class="name-row">
                      <span class="sender-name">Avinay Kumar</span>
                      <span class="dot-separator">•</span>
                      <span class="timestamp">10:32 AM</span>
                    </div>
                    <div class="role-badge portfolio">
                      <span class="label-type">Portfolio Company</span>
                      <span class="label-name">Capavate Tech</span>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-content">
                <p>
                  Query regarding Series A valuation and upcoming board meeting
                  agenda.
                </p>
              </div>
            </div>
            ...
            <div class="modern-card">
              <div class="card-top">
                <div class="user-meta">
                  ...
                  <div class="text-group">
                    <div class="name-row">
                      <span class="sender-name">Priya Sharma</span>
                      <span class="dot-separator">•</span>
                      <span class="timestamp">Yesterday</span>
                    </div>
                    <div class="role-badge shareholder">
                      <span class="label-type">Fellow Shareholder</span>
                      <span class="label-name">Ankit Verma (Zomato)</span>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-content">
                <p>Document submission update for the Q3 audit report.</p>
              </div>
            </div>
          </div>
